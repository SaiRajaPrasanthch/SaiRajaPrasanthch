...
List<ChatList> listChatList = [
  ChatList(
      ...
      isImage: true,
      strName: "Angell Feed",
      strText: 'Christian Pulisic: Hello'),
  ...
  ChatList(
      ...
      isImage: true,
      strName: "Group 1",
      strText: 'Is there any update'),
  ChatList(isGroup: true, intUnreadMsg: 7, isImage: true, strName: "Group 2"),
  ChatList(
      isGroup: false,
      intUnreadMsg: 1,
      isImage: true,
      strName: "Christian Pulisic",
      strText: 'Whatssupp'),
  ChatList(
      isGroup: false,
      intUnreadMsg: 6,
      isImage: true,
      strName: "Giovanni Reyna",
      strText: 'Hi'),
...
List<Chat> listChat = [
  ...
  Chat(
      stgMsg:
          'Where i need to drop the matterial and where i need to collect the approval',
      strStatus: status.delivered.toString(),
      strTime: "02:26 PM",
      isReceived: false),
  Chat(
      stgMsg: 'And When i will get the payment',
      strStatus: status.read.toString(),
      strTime: "02:27 PM",
      isReceived: false),
];
...
List<String> listDispute = [
  'Approved',
  'Rejected',
  'Suggest different dispute​'
];
